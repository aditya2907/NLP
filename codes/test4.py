...
# Step 3: Predict Fail Type for a New System ID and Date
def predict_fail_type(model, vectorizer, data, system_id, input_date):
    ...
    print(f"Predicted Failure Type for System {system_id} on {input_date.date()}: {prediction[0]}")
...
if __name__ == "__main__":
    ...
    # Example predictions
    predict_fail_type(model, vectorizer, df, 101, "2024-11-06")  # Example system_id = 101
    predict_fail_type(model, vectorizer, df, 102, "2024-11-06")  # Example system_id = 102
